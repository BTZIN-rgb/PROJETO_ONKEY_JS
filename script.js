function trocaPaginas() {
    ...
    // Usuário comum
        ...
        alert("Você será direcionado para a página vendas.");
        window.location.href = "vendas.html";
    }

    // Conta salário
    else if (usuario === "2" && senha === "456") {
        alert("Você será direcionado para a página estoque.");
    ...
    // Aposentado
        ...
        alert("Você será direcionado para a página administrativo.");
        window.location = "administrativo.html";
    }
